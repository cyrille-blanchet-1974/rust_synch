...
fn start_thread_read(what: Place, to_join: Sender<(Place,Fold)>, data: Vec<PathBuf>, opt: &Options) -> JoinHandle<()>
{
...
*/
pub fn start_thread_read_src(to_join: Sender<(Place,Fold)>, data: Vec<PathBuf>, opt: &Options) -> JoinHandle<()>
{
...
*/
pub fn start_thread_read_dst(to_join: Sender<(Place,Fold)>, data: Vec<PathBuf>, opt: &Options) -> JoinHandle<()>
{
